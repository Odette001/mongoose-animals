...
): Promise<DBMessageResponseSpecies> => {
  return new Promise((resolve, reject) => {
    request(app)
      ...
      .end((err, res) => {
        ...
        resolve(res.body as DBMessageResponseSpecies);
      });
  });
};
...
// NEW: Get species by area
const getSpeciesByArea = (app: Express, polygon: { type: string; coordinates: number[][][] }): Promise<TestSpecies[]> => {
  return new Promise((resolve, reject) => {
    request(app)
...
const deleteSpecies = (app: Express, id: string): Promise<DBMessageResponseSpecies> => {
  return new Promise((resolve, reject) => {
    request(app)
